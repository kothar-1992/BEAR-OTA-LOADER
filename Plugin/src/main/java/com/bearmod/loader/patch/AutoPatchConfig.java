...
public class AutoPatchConfig {
    ...
    static {
        ...
        TARGET_PATCH_MAP.put(PubgPackages.PUBG_PACKAGES[PubgPackages.GLOBAL_INDEX], Arrays.asList(
            "bypass-signkill",
            "bypass-ssl",
            "anti-detection",
            "analyzer"
        ...
        TARGET_PATCH_MAP.put(PubgPackages.PUBG_PACKAGES[PubgPackages.KOREA_INDEX], Arrays.asList(
            "bypass-signkill",
            "bypass-ssl",
            "anti-detection"
        ));
        ...
        TARGET_PATCH_MAP.put(PubgPackages.PUBG_PACKAGES[PubgPackages.VIETNAM_INDEX], Arrays.asList(
            "bypass-signkill",
            "bypass-ssl",
            "anti-detection"
        ));
        ...
        TARGET_PATCH_MAP.put(PubgPackages.PUBG_PACKAGES[PubgPackages.TAIWAN_INDEX], Arrays.asList(
            "bypass-signkill",
            "bypass-ssl",
            "anti-detection"
        ));
