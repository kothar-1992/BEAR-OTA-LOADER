...
const config = {
    ...
    // Non-root support configuration (Updated for ptrace-based injection)
    nonRoot: {
        enabled: true,           // Enable non-root injection capabilities
        injectionMode: "ptrace", // ptrace-based injection (replaces Frida Gadget)

        // Obfuscation settings (for libbearmod.so)
        obfuscation: {
            enabled: true,
            libraryName: "libbearmod.so",  // Main injection library
            ...
            encryptConfig: true            // Encrypt configuration
        },

        // Injection configuration (ptrace-based)
        injection: {
            method: "ptrace",        // ptrace-based injection (replaces gadget)
        ...
        // Advanced stealth features (Updated for ptrace-based injection)
        stealth: {
            hideThreads: true,       // Hide injection threads
