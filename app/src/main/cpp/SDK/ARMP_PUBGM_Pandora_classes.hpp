...
{
public:
	unsigned char                                      UnknownData00[0x90];                                      // 0x07B0(0x0090) MISSED OFFSET
	struct FString                                     LuaFilePath;                                              // 0x0840(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     LuaStateName;                                             // 0x0850(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
