...
// Function Addons.TransformerVehicle.SyncControlRotation
struct ATransformerVehicle_SyncControlRotation_Params
{
	float                                              DeltaTime;                                                // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.TransformerVehicle.ServerUpdateControlRotation
struct ATransformerVehicle_ServerUpdateControlRotation_Params
{
	struct FRotator                                    ControlRotation;                                          // (Parm, IsPlainOldData)
};
...
// Function Addons.TransformerVehicle.OnRep_NetControlRotation
struct ATransformerVehicle_OnRep_NetControlRotation_Params
{
};
