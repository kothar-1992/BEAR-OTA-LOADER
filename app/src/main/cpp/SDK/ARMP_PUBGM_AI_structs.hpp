...
struct FDiffAIStateInfoBaseMod : public FDiffStateInfoBase
{
	...
	TArray<struct FDamageSource>                       all_damage_source;                                        // 0x0280(0x0010) (ZeroConstructor)
	struct FDiffProgressBarState                       progress_bar;                                             // 0x0290(0x0020)
	struct FDiffAINearbyPlayersBaseMod                 nearby_player;                                            // 0x02B0(0x0038)
	struct FDiffItemStateDatas                         nearby_item;                                              // 0x02E8(0x0038)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x0320(0x0010) (ZeroConstructor)
	TArray<struct FItemStateData>                      nearby_box_item;                                          // 0x0330(0x0010) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x0340(0x0030)
	TArray<struct FAIBulletHole>                       all_bullet_hole;                                          // 0x0370(0x0010) (ZeroConstructor)
	...
	struct FDiffAIConfig                               Config;                                                   // 0x0388(0x0020)
	struct FDiffAIDestroyBulletProbInfos               destroy_bullet_prob_info;                                 // 0x03A8(0x0038)
};
...
struct FDiffMLAIStateInfoBaseMod : public FUniqueStateInfo
{
	...
	struct FDiffAIDestroyBulletProbInfos               destroy_bullet_prob_info;                                 // 0x00C0(0x0038)
};
