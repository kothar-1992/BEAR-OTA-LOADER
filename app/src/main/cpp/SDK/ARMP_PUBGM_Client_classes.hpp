...
public:
	...
	unsigned char                                      UnknownData03[0x70];                                      // 0x00C8(0x0070) MISSED OFFSET
	struct FScriptDelegate                             OpenMicFail;                                              // 0x0138(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenMicSuccess;                                           // 0x0148(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseMicFail;                                             // 0x0158(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             BeforeOperation;                                          // 0x0168(0x0010) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             KwsNotify;                                                // 0x02B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ApplyMessageKeyNotify;                                    // 0x02C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             MemberIsSpeakingNotify;                                   // 0x02D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             LbsMemberIsSpeakingNotify;                                // 0x02E8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMuteSwitchResult;                                       // 0x02F8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ReportVoiceTimeToServer;                                  // 0x0308(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordSuccess;                                            // 0x0318(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordFail;                                               // 0x0328(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadSuccess;                                            // 0x0338(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadFail;                                               // 0x0348(0x0010) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnDeliverDataCallback;                                    // 0x0490(0x0010) (ZeroConstructor, InstancedReference)
