...
public:
	...
	class UBlockyEnumWidget*                           EnumWidget;                                               // 0x0290(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockyStringWidget*                         StringWidget;                                             // 0x0298(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockyBooleanWidget*                        BooleanWidget;                                            // 0x02A0(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockyFloatWidget*                          FloatWidget;                                              // 0x02A8(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlocky3DVarWidget*                          Var3DWidget;                                              // 0x02B0(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockyIntegerWidget*                        IntegerWidget;                                            // 0x02B8(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockyColorPickerWidget*                    ColorWidget;                                              // 0x02C0(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockyPresetWidget*                         PresetWidget;                                             // 0x02C8(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockySelectFromSceneWidget*                SelectFromSceneWidget;                                    // 0x02D0(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<class UBlockyMenuItemObject*>               CurrentMenuItems;                                         // 0x02D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class UBlockyMenuItemObject*                       CurrentSerchMenuItem;                                     // 0x02E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBlockyBlockListItemObject*                  ListItemSerchAtPoint;                                     // 0x02F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterial*                                   AnimateMaterial;                                          // 0x02F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInstance*                           DeleteUIDockingMaterial;                                  // 0x0300(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInstance*                           DeleteRangeUIDockingMaterial;                             // 0x0308(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInstance*                           DeleteUIBgDockingMaterial;                                // 0x0310(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBlockyMenuWidget*                           MenuWidget;                                               // 0x0318(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockyCategoryWidget*                       CategoryWidget;                                           // 0x0320(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockyBlockWindowWidget*                    BlockWindowWidget;                                        // 0x0328(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlockyLogWidget*                            BlockyLogWidget;                                          // 0x0330(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	float                                              PresetTagTitleY;                                          // 0x0338(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x033C(0x0004) MISSED OFFSET
	class UBlockyMenuItemWidget*                       CurrentMenuItemWidget;                                    // 0x0340(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TMap<struct FString, class UBlockyBlockListItemObject*> TypeFilterItems;                                          // 0x0348(0x0050) (ZeroConstructor)
	TMap<struct FString, class UBlockyBlockListItemObject*> TypeFilterArrayItems;                                     // 0x0398(0x0050) (ZeroConstructor)
	TArray<class UBlockyMenuItemObject_TypeFilter*>    TypeFilterMenus;                                          // 0x03E8(0x0010) (ZeroConstructor)
	TArray<class UBlockyCategoryItemObject*>           CurrentSlotPresetCategorys;                               // 0x03F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData03[0x50];                                      // 0x0408(0x0050) MISSED OFFSET
...
public:
	...
	class UDeleteBlockUI*                              DeleteBlockUI;                                            // 0x02E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UBlockySearchWidget*                         SearchHost;                                               // 0x0C70(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0C78(0x0008) MISSED OFFSET
	class UClass*                                      ItemString;                                               // 0x0C80(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      ItemIcon;                                                 // 0x0C88(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x10];                                      // 0x0C90(0x0010) MISSED OFFSET
	class UCanvasPanel*                                CanvasPanel;                                              // 0x0CA0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
// 0x0038 (0x0CE0 - 0x0CA8)
class UBlockyLoopScrollBox : public UBlockyLoopScrollBase
{
public:
	struct FVector2D                                   StringItemSize;                                           // 0x0CA8(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   IconItemSize;                                             // 0x0CB0(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   StringItemPadding;                                        // 0x0CB8(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   IconItemPadding;                                          // 0x0CC0(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bAlignMagnetic;                                           // 0x0CC8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x0CC9(0x0017) MISSED OFFSET
...
{
public:
	struct FVector2D                                   ItemSize;                                                 // 0x0CA8(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   Padding;                                                  // 0x0CB0(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bAlignGrid;                                               // 0x0CB8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlignAnimation;                                          // 0x0CB9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x16];                                      // 0x0CBA(0x0016) MISSED OFFSET
