...
public:
	...
	unsigned char                                      UnknownData06[0x928];                                     // 0x03D0(0x0928) MISSED OFFSET
	class USCoronaClientData*                          SecurityCoronaLabClientDataPointer;                       // 0x0CF8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x68];                                      // 0x0D00(0x0068) MISSED OFFSET
	bool                                               bMHActive;                                                // 0x0D68(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0xAF];                                      // 0x0D69(0x00AF) MISSED OFFSET
	TMap<int, int>                                     FFItemIDMap;                                              // 0x0E18(0x0050) (ZeroConstructor)
	TMap<int, int>                                     FFWeaponItemIDMap;                                        // 0x0E68(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x1C];                                      // 0x0EB8(0x001C) MISSED OFFSET
	int                                                ReceivedRotationModifiedCount;                            // 0x0ED4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedTranslationModifiedCount;                         // 0x0ED8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedScale3DModifiedCount;                             // 0x0EDC(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        LastInvalidIndexListInPakLite;                            // 0x0EE0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData10[0x8];                                       // 0x0EF0(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnServerReceiveInvalidFilesInPakLiteDelegate;             // 0x0EF8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData11[0xE8];                                      // 0x0F08(0x00E8) MISSED OFFSET
	float                                              TouchScreenActiveTimeRatioThreshold;                      // 0x0FF0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0FF4(0x0004) MISSED OFFSET
	float                                              MouTa;                                                    // 0x0FF8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BandaCountThreshold;                                      // 0x0FFC(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bEnableBandCount;                                         // 0x1000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x3];                                       // 0x1001(0x0003) MISSED OFFSET
	float                                              IntervalThreshold1;                                       // 0x1004(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HongThreshold;                                            // 0x1008(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              NovoThreshold;                                            // 0x100C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x40];                                      // 0x1010(0x0040) MISSED OFFSET
	int                                                MaxCountOfPlayerHistoryLocationToDetectCamouflage;        // 0x1050(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0xC];                                       // 0x1054(0x000C) MISSED OFFSET
	float                                              MinDistanceToDetectCamouflage;                            // 0x1060(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0xC];                                       // 0x1064(0x000C) MISSED OFFSET
