...
public:
	...
	float                                              DebugAngle;                                               // 0x0C68(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	static struct FVector FindEmptySpace(class UObject* Object, const struct FVector& Pos, bool bAbove, float MapLimit, int MaxAttempts, float BoxSize);
...
public:
	...
	TMap<struct FString, struct FString>               MapVehicleClassPathConfigs;                               // 0x23E0(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
	ECreativeModeGameType                              EditorStartupGameType;                                    // 0x2430(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x2431(0x0001) MISSED OFFSET
	bool                                               bIsCreativeWoW;                                           // 0x2432(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x5];                                       // 0x2433(0x0005) MISSED OFFSET
	struct FGameModeLiteComponentTickFunction          LiteComponentActorTick;                                   // 0x2438(0x0058) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x2490(0x0010) (ZeroConstructor, Transient)
...
// 0x00C8 (0x1598 - 0x14D0)
class ACreativeModeGameState : public ASTExtraGameStateBase
{
public:
	unsigned char                                      UnknownData00[0x2];                                       // 0x14D0(0x0002) MISSED OFFSET
	unsigned char                                      bIsCreativeMode : 1;                                      // 0x14D2(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	ECreativeModeGameType                              CurrentGameType;                                          // 0x14D3(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	ECreativeModeGameType                              InitializeGameType;                                       // 0x14D4(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x14D5(0x0003) MISSED OFFSET
	int                                                CreativeModID;                                            // 0x14D8(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                CreativeModTemplateId;                                    // 0x14DC(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	class UCreativeModeGameStateBaseComponent*         CurrentStateComponent;                                    // 0x14E0(0x0008) (Net, ZeroConstructor, Transient, IsPlainOldData)
	class UCreativeModeGameStateBaseComponent*         LastStateComponent;                                       // 0x14E8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<class UClass*>                              GameStateComponentClassArray;                             // 0x14F0(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      GameStateComponentClass;                                  // 0x1500(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bIsCreativeWoW;                                           // 0x1508(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x17];                                      // 0x1509(0x0017) MISSED OFFSET
	TArray<struct FBlockySlotString>                   BlockySlotStrings;                                        // 0x1520(0x0010) (Net, ZeroConstructor, Transient)
	struct FGameStateLiteComponentTickFunction         LiteComponentActorTick;                                   // 0x1530(0x0058) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x1588(0x0010) (ZeroConstructor, Transient)
...
public:
	...
	struct FOctreeNode                                 RootNode;                                                 // 0x0118(0x0030) (Edit, BlueprintVisible)
	float                                              CellSize;                                                 // 0x0148(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MergeDistance;                                            // 0x014C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxDepth;                                                 // 0x0150(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MinCellSize;                                              // 0x0154(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                SplitThreshold;                                           // 0x0158(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCheckObstacles;                                          // 0x015C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	bool                                               bEnableAutoPickUp;                                        // 0x1C20(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x1C21(0x0007) MISSED OFFSET
...
{
public:
	float                                              VoxelSize;                                                // 0x04F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AreaThreshold;                                            // 0x04FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableDebugLogging;                                      // 0x0500(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0501(0x0003) MISSED OFFSET
	float                                              OwnershipCoverageThreshold;                               // 0x0504(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnoccupiedOwnerID;                                        // 0x0508(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      ReservedOwnerIDStart;                                     // 0x0509(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      ReservedOwnerIDEnd;                                       // 0x050A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      MaxUserCount;                                             // 0x050B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      StartingUserID;                                           // 0x050C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x050D(0x0003) MISSED OFFSET
	float                                              DebugColorScale;                                          // 0x0510(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DebugDrawDuration;                                        // 0x0514(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DebugLineThickness;                                       // 0x0518(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DebugVoxelBoxSize;                                        // 0x051C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseOctreeForSmallTriangles;                              // 0x0520(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0521(0x0003) MISSED OFFSET
	int                                                OctreeMaxDepth;                                           // 0x0524(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                OctreeMaxTrianglesPerLeaf;                                // 0x0528(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OctreeMinNodeSize;                                        // 0x052C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnablePartialSplit;                                      // 0x0530(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0531(0x0003) MISSED OFFSET
	float                                              PartialSplitMinArea;                                      // 0x0534(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                PartialSplitMaxDepth;                                     // 0x0538(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x053C(0x0004) MISSED OFFSET
	TArray<struct FPaintTriangleInfo>                  SmallTriangles;                                           // 0x0540(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	unsigned char                                      UnknownData05[0x40];                                      // 0x0550(0x0040) MISSED OFFSET
	TMap<struct FPaintVoxelCoord, struct FPaintVoxelCell> SparseVoxelHash;                                          // 0x0590(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FPaintVoxelCoord>                    PrecomputedDiskOffsets;                                   // 0x05E0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<unsigned char, float>                         PerUserAreaCache;                                         // 0x05F0(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FDeferredPaintOp>                    DeferredOps;                                              // 0x0640(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<struct FString, unsigned char>                UserNameToID;                                             // 0x0650(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<unsigned char, struct FString>                IDToUserName;                                             // 0x06A0(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	unsigned char                                      NextUserID;                                               // 0x06F0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x06F1(0x0003) MISSED OFFSET
	float                                              TotalScore;                                               // 0x06F4(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bInitialized;                                             // 0x06F8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2F];                                      // 0x06F9(0x002F) MISSED OFFSET
...
public:
	...
	TArray<int>                                        MapMarkInstanceIDList;                                    // 0x0590(0x0010) (ZeroConstructor)
