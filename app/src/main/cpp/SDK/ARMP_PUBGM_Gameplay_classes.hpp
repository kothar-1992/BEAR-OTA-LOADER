...
public:
	...
	ECharacterGender                                   DefaultCharacterGender;                                   // 0x0938(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData21[0x420];                                     // 0x0CE0(0x0420) MISSED OFFSET
	bool                                               bIsPreCreatingPlayerController;                           // 0x1100(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData22[0x13F];                                     // 0x1101(0x013F) MISSED OFFSET
	float                                              OBInfoTimeStep;                                           // 0x1240(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData23[0x2C];                                      // 0x1244(0x002C) MISSED OFFSET
	...
	unsigned char                                      UnknownData24[0xD8];                                      // 0x12A0(0x00D8) MISSED OFFSET
	...
	unsigned char                                      UnknownData26[0x4];                                       // 0x13EC(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData27[0x3];                                       // 0x1401(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData28[0x4];                                       // 0x1414(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData29[0x7];                                       // 0x1429(0x0007) MISSED OFFSET
	...
	unsigned char                                      UnknownData30[0xA0];                                      // 0x14F0(0x00A0) MISSED OFFSET
	bool                                               UseGMSpawnItemSpotDefaultTag;                             // 0x1590(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData31[0x7];                                       // 0x1591(0x0007) MISSED OFFSET
	struct FString                                     GMSpawnItemSpotDefaultTag;                                // 0x1598(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData32[0x80];                                      // 0x15A8(0x0080) MISSED OFFSET
	...
	unsigned char                                      UnknownData33[0x2];                                       // 0x162A(0x0002) MISSED OFFSET
...
{
public:
	struct FName                                       RepPropertyCategory;                                      // 0x0550(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5];                                       // 0x0558(0x0005) MISSED OFFSET
	bool                                               bTeamIDChgDeactivePawn;                                   // 0x055D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x52];                                      // 0x055E(0x0052) MISSED OFFSET
	struct FString                                     WeaponAttrReloadTableName;                                // 0x05B0(0x0010) (Edit, ZeroConstructor)
	struct FString                                     DamageSearchTableName;                                    // 0x05C0(0x0010) (Edit, ZeroConstructor)
	bool                                               IsInitTable;                                              // 0x05D0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideInstigatorEnable;                                // 0x05D1(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x05D2(0x0006) MISSED OFFSET
...
// 0x0B60 (0x13C8 - 0x0868)
class AUAEPlayerController : public ALuaPlayerController
{
public:
	struct FScriptMulticastDelegate                    OnPlayerKeyRepDelegate;                                   // 0x0868(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0878(0x0010) MISSED OFFSET
	struct FName                                       RepPropertyCategory;                                      // 0x0888(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       PlayerType;                                               // 0x0890(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     PlayerName;                                               // 0x0898(0x0010) (Net, ZeroConstructor)
	uint32_t                                           PlayerKey;                                                // 0x08A8(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x08AC(0x0004) MISSED OFFSET
	uint64_t                                           UID;                                                      // 0x08B0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     PlayerOpenID;                                             // 0x08B8(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	...
	int64_t                                            IdxInTeam;                                                // 0x08D0(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	int                                                Campid;                                                   // 0x08D8(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     CharacterLocation;                                        // 0x08DC(0x000C) (Net, IsPlainOldData)
	int                                                RoomMode;                                                 // 0x08E8(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x08EC(0x0004) MISSED OFFSET
	struct FWeatherInfo                                WeatherInfo;                                              // 0x08F0(0x0018) (Net)
	int                                                planeAvatarId;                                            // 0x0908(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                DyeDebugFlag;                                             // 0x090C(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                PlayerStartID;                                            // 0x0910(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bUsedSimulation;                                          // 0x0914(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0915(0x0003) MISSED OFFSET
	struct FPlayerNetStats                             NetStats;                                                 // 0x0918(0x0040)
	bool                                               bEnablePlaneBanner;                                       // 0x0958(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x7];                                       // 0x0959(0x0007) MISSED OFFSET
	struct FString                                     PlanetailResLink;                                         // 0x0960(0x0010) (Net, ZeroConstructor)
	int                                                InPacketLossRate;                                         // 0x0970(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                OutPacketLossRate;                                        // 0x0974(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ClientNetworkType;                                        // 0x0978(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x24];                                      // 0x097C(0x0024) MISSED OFFSET
	bool                                               bIsForReplay;                                             // 0x09A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bIsGlobalObserverForReplay;                               // 0x09A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x09A2(0x0002) MISSED OFFSET
	int                                                GameReplayType;                                           // 0x09A4(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bDisableProcessPlayerInput;                               // 0x09A8(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bNoAttenuationGlobalVoice;                                // 0x09A9(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x6];                                       // 0x09AA(0x0006) MISSED OFFSET
	struct FGameModePlayerUpassInfo                    InitialUpassInfo;                                         // 0x09B0(0x0038)
	TArray<struct FGameModePlayerUpassInfo>            InitialUpassInfoList;                                     // 0x09E8(0x0010) (ZeroConstructor)
	TArray<struct FPlayerOBInfo>                       PlayerOBInfoList;                                         // 0x09F8(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	int                                                LobbyShowWeaponID;                                        // 0x0A08(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsGM;                                                    // 0x0A0C(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x0A0D(0x0003) MISSED OFFSET
	struct FString                                     Nation;                                                   // 0x0A10(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	bool                                               bIsTeammateEscaped;                                       // 0x0A20(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x7];                                       // 0x0A21(0x0007) MISSED OFFSET
	ECharacterGender                                   DefaultCharacterGender;                                   // 0x0A28(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0A29(0x0003) MISSED OFFSET
	int                                                DefaultCharacterHeadID;                                   // 0x0A2C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<struct FGameModePlayerItem>                 InitialItemList;                                          // 0x0A30(0x0010) (BlueprintVisible, ZeroConstructor)
	TArray<struct FGameModePlayerRolewearInfo>         InitialAllWear;                                           // 0x0A40(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	int                                                RolewearIndex;                                            // 0x0A50(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0A54(0x0004) MISSED OFFSET
	TArray<int>                                        equip_plating_list;                                       // 0x0A58(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 InitialSharedSkin;                                        // 0x0A68(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	struct FGameModePlayerKnapsackSingleInfo           InitialSharedKnapsack;                                    // 0x0A78(0x0088) (BlueprintVisible, Net)
	bool                                               bSharedSkinOpened;                                        // 0x0B00(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bUsingSharedSkin;                                         // 0x0B01(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bSubscribeBagOpened;                                      // 0x0B02(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x1];                                       // 0x0B03(0x0001) MISSED OFFSET
	int                                                FashionBagStartIndex;                                     // 0x0B04(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	int                                                VehicleSkinInReady;                                       // 0x0B08(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bSpwanInVehiclePlayerStart;                               // 0x0B0C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x3];                                       // 0x0B0D(0x0003) MISSED OFFSET
	TArray<struct FGameModePlayerItem>                 InitialWeaponAvatarList;                                  // 0x0B10(0x0010) (BlueprintVisible, ZeroConstructor)
	struct FGameModePlayerPetInfo                      InitialPetInfo;                                           // 0x0B20(0x0020) (BlueprintVisible, BlueprintReadOnly, Net)
	TArray<struct FGameModePlayerPetInfo>              AdditionalPetInfo;                                        // 0x0B40(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	int                                                UsingAdditionalPetIndex;                                  // 0x0B50(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x4];                                       // 0x0B54(0x0004) MISSED OFFSET
	TArray<struct FGameModePlayerKnapsackExtInfo>      InitialKnapsackExtInfo;                                   // 0x0B58(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	TArray<struct FGameModePlayeWeaponSchemeInfo>      InitialWeaponSchemeInfo;                                  // 0x0B68(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	TArray<struct FPlayerEffectItemInfo>               InitialEffectItemInfo;                                    // 0x0B78(0x0010) (Net, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnInitialWeaponScheme;                                    // 0x0B88(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInitialEffectItem;                                      // 0x0B98(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	int                                                CurWeaponSchemeIndex;                                     // 0x0BA8(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	int                                                PveLevel;                                                 // 0x0BAC(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	TArray<int>                                        InitialCharSkillList;                                     // 0x0BB0(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 InitialVehicleAvatarList;                                 // 0x0BC0(0x0010) (BlueprintVisible, ZeroConstructor)
	TArray<struct FGameModePlayerItems>                InitialVehicleAvatarSkinList;                             // 0x0BD0(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	int                                                nVehicleSwitchEffectId;                                   // 0x0BE0(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	int                                                ShowVehicleSkin;                                          // 0x0BE4(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FGameModePlayerItem>                 InitialBackPackPendantList;                               // 0x0BE8(0x0010) (BlueprintVisible, ZeroConstructor)
	TArray<struct FVehicleAvatarData>                  InitialVehicleAdvanceAvatarList;                          // 0x0BF8(0x0010) (BlueprintVisible, ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 InitialVehicleMusicList;                                  // 0x0C08(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	struct FGameModePlayerConsumableAvatar             InitialConsumableAvatar;                                  // 0x0C18(0x0010) (BlueprintVisible, Net)
	struct FGameModePlayerEquipmentAvatar              InitialEquipmentAvatar;                                   // 0x0C28(0x0030) (BlueprintVisible, Net)
	TMap<int, int>                                     WeaponAvatarItemList;                                     // 0x0C58(0x0050) (BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData16[0x50];                                      // 0x0CA8(0x0050) MISSED OFFSET
	TMap<int, int>                                     GrenadeAvatarItemList;                                    // 0x0CF8(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FGameModeWeaponAvatarData>           WeaponAvatarDataList;                                     // 0x0D48(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	TMap<int, int>                                     VehicleAvatarList;                                        // 0x0D58(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<int, struct FVehicleAvatarData>               VehicleAdvanceAvatarList;                                 // 0x0DA8(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<int, struct FVehicleAvatarSkinList>           VehicleAvatarSkinList;                                    // 0x0DF8(0x0050) (BlueprintVisible, ZeroConstructor)
	TArray<int>                                        VehicleMusicList;                                         // 0x0E48(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	TArray<int>                                        DefaultVehicleMusic;                                      // 0x0E58(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	TArray<struct FGameModePlayerExpressionItem>       InitialExpressionItemList;                                // 0x0E68(0x0010) (ZeroConstructor)
	TArray<struct FGameModeWeaponDIYPlanData>          InitialWeaponDIYPlanData;                                 // 0x0E78(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<int, int>                                     WeaponDIYPlanDataMap;                                     // 0x0E88(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TMap<int, int>                                     InitialWeaponPendantList;                                 // 0x0ED8(0x0050) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FGameModePlayerTaskData>             InitialTaskDataList;                                      // 0x0F28(0x0010) (ZeroConstructor)
	TArray<struct FSpecialPickItem>                    InitialSpecialPickItemList;                               // 0x0F38(0x0010) (ZeroConstructor)
	TArray<struct FDailyTaskStoreInfo>                 DailyTaskStoreList;                                       // 0x0F48(0x0010) (ZeroConstructor)
	uint32_t                                           TaskSyncToDsTs;                                           // 0x0F58(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x4];                                       // 0x0F5C(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnPlayerGotoSpectatingDelegate;                           // 0x0F60(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData18[0x10];                                      // 0x0F70(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnReceiveUIMessage;                                       // 0x0F80(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	int64_t                                            LastGameResultTime;                                       // 0x0F90(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bRoomCanKickPlayer;                                       // 0x0F98(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bCanDownloadInBattle;                                     // 0x0F99(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData19[0x6];                                       // 0x0F9A(0x0006) MISSED OFFSET
	struct FString                                     IpCountryStr;                                             // 0x0FA0(0x0010) (ZeroConstructor)
	bool                                               bRoomOwner;                                               // 0x0FB0(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bOpenChangeWearing;                                       // 0x0FB1(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData20[0x2];                                       // 0x0FB2(0x0002) MISSED OFFSET
	uint32_t                                           ObserverFlags;                                            // 0x0FB4(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bIsSpectating;                                            // 0x0FB8(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData21[0x3];                                       // 0x0FB9(0x0003) MISSED OFFSET
	struct FLobbyWatchInfo                             LobbyWatchInfo;                                           // 0x0FBC(0x0008) (Net)
	int                                                HawkEyeSpectateMaxMatchCount;                             // 0x0FC4(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                HawkEyeSpectateUsedMatchCount;                            // 0x0FC8(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bIsWatchEnd;                                              // 0x0FCC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData22[0x3];                                       // 0x0FCD(0x0003) MISSED OFFSET
	float                                              UpdateOBCircleCounter;                                    // 0x0FD0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              UpdateOBCircleInterval;                                   // 0x0FD4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAllowAutoSelectTeamMate;                                 // 0x0FD8(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bWaitRetryGotoSpectating;                                 // 0x0FD9(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData23[0x6];                                       // 0x0FDA(0x0006) MISSED OFFSET
	TArray<struct FString>                             FriendObservers;                                          // 0x0FE0(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData24[0x1];                                       // 0x0FF0(0x0001) MISSED OFFSET
	bool                                               bCanLedgeGrab;                                            // 0x0FF1(0x0001) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData25[0x6];                                       // 0x0FF2(0x0006) MISSED OFFSET
	bool                                               bIsSpectatingEnemy;                                       // 0x0FF8(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData26[0x5F];                                      // 0x0FF9(0x005F) MISSED OFFSET
	TWeakObjectPtr<class UUAEUserWidget>               InGameUIRoot;                                             // 0x1058(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<struct FSoftClassPath>                      LevelUpdateNetActorClassPaths;                            // 0x1060(0x0010) (ZeroConstructor, Config)
	TArray<class UClass*>                              LevelUpdateNetActorClassList;                             // 0x1070(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData27[0x53];                                      // 0x1080(0x0053) MISSED OFFSET
	bool                                               bExited;                                                  // 0x10D3(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bReconnected;                                             // 0x10D4(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	bool                                               bReconnecting;                                            // 0x10D5(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData28[0x12];                                      // 0x10D6(0x0012) MISSED OFFSET
	struct FScriptMulticastDelegate                    PlayerControllerLostDelegate;                             // 0x10E8(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SyncDailyTaskInfoDelegate;                                // 0x10F8(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerRecoveredDelegate;                        // 0x1108(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerAboutToReconnectDelegate;                 // 0x1118(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerReconnectedDelegate;                      // 0x1128(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerAboutToRespawnDelegate;                   // 0x1138(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerRespawnedDelegate;                        // 0x1148(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PlayerControllerAboutToExitDelegate;                      // 0x1158(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPlayerQuitSpectatingForClient;                          // 0x1168(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPlayerControllerBattleBeginPlay;                        // 0x1178(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInitGameUI;                                             // 0x1188(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData29[0x10];                                      // 0x1198(0x0010) MISSED OFFSET
	bool                                               bCanWatchEnemyInRoomMode;                                 // 0x11A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData30[0x107];                                     // 0x11A9(0x0107) MISSED OFFSET
	TArray<class UObject*>                             SecurityObjs;                                             // 0x12B0(0x0010) (ZeroConstructor)
	TArray<int>                                        BuffEffectDisplayIDArray;                                 // 0x12C0(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	bool                                               IsDelayNotifyEnterBattleUntilLevelLoad;                   // 0x12D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData31[0x3];                                       // 0x12D1(0x0003) MISSED OFFSET
	float                                              NotifyTimeOut;                                            // 0x12D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DelayCloseLoadingTime;                                    // 0x12D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData32[0x4];                                       // 0x12DC(0x0004) MISSED OFFSET
	struct FString                                     NeedLoadLevelName;                                        // 0x12E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     NeedLoadedLevelFullName;                                  // 0x12F0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               IsTickHouse;                                              // 0x1300(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData33[0xF];                                       // 0x1301(0x000F) MISSED OFFSET
	int                                                AntiDataCD;                                               // 0x1310(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ModeID;                                                   // 0x1314(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bOpenReconnectUseCharViewPoint;                           // 0x1318(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData34[0x2B];                                      // 0x1319(0x002B) MISSED OFFSET
	float                                              ClientToDSFlowLimitTime;                                  // 0x1344(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ClientToDSFlowLimit;                                      // 0x1348(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData35[0x24];                                      // 0x134C(0x0024) MISSED OFFSET
	struct FString                                     UsingNetObjectPathNameMappingCSV;                         // 0x1370(0x0010) (Net, ZeroConstructor)
	struct FString                                     UsingOodleNetworkDicPath;                                 // 0x1380(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData36[0x20];                                      // 0x1390(0x0020) MISSED OFFSET
	class ANetworkReportActor*                         NetworkReportActor;                                       // 0x13B0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData37[0x10];                                      // 0x13B8(0x0010) MISSED OFFSET
...
public:
	...
	TMap<struct FString, class UObject*>               ProxyMap;                                                 // 0x0528(0x0050) (ZeroConstructor)
...
public:
	...
	class AAIController*                               AIOwner;                                                  // 0x00B8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class AActor*                                      ActorOwner;                                               // 0x00C0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	...
	TArray<struct FString>                             LuaStringParams;                                          // 0x00F0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<float>                                      LuaNumberParams;                                          // 0x0100(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FBlackboardKeySelector>              LuaBlackboardParams;                                      // 0x0110(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
public:
	...
	TArray<struct FString>                             LuaStringParams;                                          // 0x00E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<float>                                      LuaNumberParams;                                          // 0x00F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FBlackboardKeySelector>              LuaBlackboardParams;                                      // 0x0108(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
public:
	...
	TArray<struct FString>                             LuaStringParams;                                          // 0x00F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<float>                                      LuaNumberParams;                                          // 0x0108(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FBlackboardKeySelector>              LuaBlackboardParams;                                      // 0x0118(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
