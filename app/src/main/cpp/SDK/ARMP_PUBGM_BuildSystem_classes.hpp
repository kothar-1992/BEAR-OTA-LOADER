...
public:
	...
	bool                                               bCanBuild;                                                // 0x0210(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UParticleSystemComponent*                    SelectBuildEffect;                                        // 0x04F8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	class UStaticMeshComponent*                        SelectEffectMesh;                                         // 0x0500(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
