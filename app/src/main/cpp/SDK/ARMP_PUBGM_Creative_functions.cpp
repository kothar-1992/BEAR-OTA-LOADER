...
// Function Creative.CreativeModeBlueprintLibrary.FindEmptySpace
...
// float                          MapLimit                       (Parm, ZeroConstructor, IsPlainOldData)
// int                            MaxAttempts                    (Parm, ZeroConstructor, IsPlainOldData)
// float                          BoxSize                        (Parm, ZeroConstructor, IsPlainOldData)
// struct FVector                 ReturnValue                    (Parm, OutParm, ReturnParm, IsPlainOldData)

struct FVector UCreativeModeBlueprintLibrary::FindEmptySpace(class UObject* Object, const struct FVector& Pos, bool bAbove, float MapLimit, int MaxAttempts, float BoxSize)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeModeBlueprintLibrary.FindEmptySpace");

	UCreativeModeBlueprintLibrary_FindEmptySpace_Params params;
	params.Object = Object;
	params.Pos = Pos;
	params.bAbove = bAbove;
	params.MapLimit = MapLimit;
