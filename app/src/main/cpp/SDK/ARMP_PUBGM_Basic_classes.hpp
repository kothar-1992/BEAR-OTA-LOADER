...
{
public:
	struct FClientBaseInfo                             ClientBaseInfo;                                           // 0x02D0(0x0158)
	struct FScriptMulticastDelegate                    EnginePreTick;                                            // 0x0428(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x68];                                      // 0x0438(0x0068) MISSED OFFSET
	class UFrontendHUD*                                AssociatedFrontendHUD;                                    // 0x04A0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x04A8(0x0008) MISSED OFFSET
	class ULuaStateWrapper*                            LuaStateWrapper;                                          // 0x04B0(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bStandAloneFromLobby;                                     // 0x04B8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x27];                                      // 0x04B9(0x0027) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnPreBattleResult;                                        // 0x04E0(0x0010) (BlueprintVisible, ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0x10];                                      // 0x04F0(0x0010) MISSED OFFSET
	TArray<struct FString>                             HighWeatherNames;                                         // 0x0500(0x0010) (ZeroConstructor, Config)
	int                                                HighWeatherMinRenderQuality;                              // 0x0510(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	int                                                HighWeatherMaxRenderQuality;                              // 0x0514(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	int                                                ModeID;                                                   // 0x0518(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x051C(0x0004) MISSED OFFSET
	struct FString                                     ModType;                                                  // 0x0520(0x0010) (ZeroConstructor)
	struct FString                                     ModType2;                                                 // 0x0530(0x0010) (ZeroConstructor)
	TArray<struct FString>                             ExtraModules;                                             // 0x0540(0x0010) (ZeroConstructor)
...
public:
	...
	void RemoveBuffByInstID(int InstID);
...
public:
	...
	unsigned char                                      UnknownData00[0x110];                                     // 0x0058(0x0110) MISSED OFFSET
	TArray<class UUAEDataTable*>                       TableObjList;                                             // 0x0168(0x0010) (ZeroConstructor)
	class UWorld*                                      CurWorld;                                                 // 0x0178(0x0008) (ZeroConstructor, IsPlainOldData)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> TableObjMap;                                              // 0x0180(0x0050) (ZeroConstructor)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> TableObjMap_Mod;                                          // 0x01D0(0x0050) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnTableCreateInFighting;                                  // 0x0220(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x118];                                     // 0x0230(0x0118) MISSED OFFSET
	struct FString                                     PathCompressionConfigsPath;                               // 0x0348(0x0010) (ZeroConstructor, Config)
	bool                                               bIsPathCompression;                                       // 0x0358(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIsPathCompressionCache;                                  // 0x0359(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x035A(0x0002) MISSED OFFSET
	int                                                PathCompressionCacheMaxSize;                              // 0x035C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bTranslationFallBackUnloadDuplicate;                      // 0x0360(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bShrinkTranslationMap;                                    // 0x0361(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bSpeedUpLoadLocalizationText;                             // 0x0362(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAsyncLoadLocalizationTable;                              // 0x0363(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bLoadPathCompressionCfgWhenReadTable;                     // 0x0364(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bGenerateTrieTreeFromDict;                                // 0x0365(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0366(0x0002) MISSED OFFSET
	TArray<struct FString>                             TableToPreLoadPathCompression;                            // 0x0368(0x0010) (ZeroConstructor, Config)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0378(0x0008) MISSED OFFSET
	struct FString                                     BaseTableRelativeDir;                                     // 0x0380(0x0010) (ZeroConstructor, Config)
	struct FString                                     ModTableRelativeDir;                                      // 0x0390(0x0010) (ZeroConstructor, Config)
	struct FString                                     SplitModTableRelativeDir;                                 // 0x03A0(0x0010) (ZeroConstructor, Config)
	TArray<struct FString>                             BaseModTableConfig;                                       // 0x03B0(0x0010) (ZeroConstructor, Config)
	TArray<struct FName>                               LobbyTableToLoadInMainCity;                               // 0x03C0(0x0010) (ZeroConstructor, Config)
	TMap<struct FName, class UModTable*>               ModTableMap;                                              // 0x03D0(0x0050) (ZeroConstructor)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> ModTableObjMap;                                           // 0x0420(0x0050) (ZeroConstructor)
	TArray<class UUAEDataTable*>                       InGameTableObjList;                                       // 0x0470(0x0010) (ZeroConstructor)
	TMap<struct FName, bool>                           CheckNeedModMap;                                          // 0x0480(0x0050) (ZeroConstructor)
	struct FString                                     CurrentModName;                                           // 0x04D0(0x0010) (ZeroConstructor)
	struct FString                                     EmptyModName;                                             // 0x04E0(0x0010) (ZeroConstructor)
	TMap<struct FString, class UBaseTableResMap*>      LoadedTableMap;                                           // 0x04F0(0x0050) (ZeroConstructor)
	TMap<struct FString, bool>                         CheckMapTable;                                            // 0x0540(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x60];                                      // 0x0590(0x0060) MISSED OFFSET
