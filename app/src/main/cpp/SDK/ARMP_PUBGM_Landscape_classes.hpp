...
public:
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x06B0(0x0188) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bGenerateOverlapEvents : 1;                               // 0x0838(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bBakeMaterialPositionOffsetIntoCollision : 1;             // 0x0838(0x0001) (Edit)
	unsigned char                                      bUseHoleConsistent : 1;                                   // 0x0838(0x0001) (Edit)
	unsigned char                                      UnknownData13[0x3];                                       // 0x0839(0x0003) MISSED OFFSET
	int                                                ComponentSizeQuads;                                       // 0x083C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubsectionSizeQuads;                                      // 0x0840(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumSubsections;                                           // 0x0844(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUsedForNavigation : 1;                                   // 0x0848(0x0001) (Edit)
	unsigned char                                      bMobileMultiLayers : 1;                                   // 0x0848(0x0001) (Edit)
	ENavDataGatheringMode                              NavigationGeometryGatheringMode;                          // 0x0849(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeForCullingInvisibleHLODVertices;             // 0x084A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeVT;                                          // 0x084B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x4];                                       // 0x084C(0x0004) MISSED OFFSET
	class UTexture2D*                                  MaskTextureUsedByGrassClear;                              // 0x0850(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData15[0x168];                                     // 0x0858(0x0168) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xA0];                                      // 0x09C0(0x00A0) MISSED OFFSET
...
{
public:
	TLazyObjectPtr<class ALandscape>                   LandscapeActor;                                           // 0x09C0(0x001C) (Edit, IsPlainOldData)
	bool                                               bLandscapeProxyUseSceenSizeLOD;                           // 0x09DC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
