...
// Function Basic.STBuffSystemComponent.RemoveBuffByInstID
// (Final, Native, Public)
// Parameters:
// int                            InstID                         (Parm, ZeroConstructor, IsPlainOldData)

void USTBuffSystemComponent::RemoveBuffByInstID(int InstID)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Basic.STBuffSystemComponent.RemoveBuffByInstID");

	USTBuffSystemComponent_RemoveBuffByInstID_Params params;
	params.InstID = InstID;
