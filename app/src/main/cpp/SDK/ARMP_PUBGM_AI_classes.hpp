...
public:
	...
	struct FFakePlayerParams                           CacheFPParams;                                            // 0x0228(0x0014)
	struct FAIPlayerParams                             CacheAIPParams;                                           // 0x023C(0x000C)
	struct FVehicleParams                              CacheVehicleParams;                                       // 0x0248(0x0014)
	unsigned char                                      UnknownData02[0x4];                                       // 0x025C(0x0004) MISSED OFFSET
	TMap<TEnumAsByte<enum EBotCategray>, int>          UnitsNumberThreshold;                                     // 0x0260(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData03[0xF0];                                      // 0x02B0(0x00F0) MISSED OFFSET
...
{
public:
	float                                              LoseSightRadius;                                          // 0x0248(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              QueryEnemyRange;                                          // 0x024C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              QueryEnemyAngle;                                          // 0x0250(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MinTimeLockTarget;                                        // 0x0254(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxRememberEnemySeconds;                                  // 0x0258(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PreciseHatredDecreaseSpeed;                               // 0x025C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCorrectAfterTurnOver : 1;                                // 0x0260(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0261(0x0003) MISSED OFFSET
	float                                              CorrectAfterTurnOverCD;                                   // 0x0264(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FollowSegmentTolerance;                                   // 0x0268(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x026C(0x0004) MISSED OFFSET
	class UCurveFloat*                                 CurveThrottleInput;                                       // 0x0270(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinAngleWhenPivotSteering;                                // 0x0278(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x027C(0x0004) MISSED OFFSET
	class UCurveFloat*                                 CurveThrottleRateWhenTurning;                             // 0x0280(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 CurveSteeringInput;                                       // 0x0288(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseBrakeWhenTurning;                                     // 0x0290(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0291(0x0003) MISSED OFFSET
	float                                              MinRequiredSteeringChange;                                // 0x0294(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinLengthRateAlmostReach;                                 // 0x0298(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x029C(0x0004) MISSED OFFSET
	class UCurveFloat*                                 CurveBrakeAlmostReach;                                    // 0x02A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SteeringThresholdUseBrake;                                // 0x02A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpeedThresholdUseBrake;                                   // 0x02AC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bBlockTest : 1;                                           // 0x02B0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData05[0x3];                                       // 0x02B1(0x0003) MISSED OFFSET
	float                                              BlockTestingTime;                                         // 0x02B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BlockSpeedThresholdKMH;                                   // 0x02B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x02BC(0x0004) MISSED OFFSET
	class UClass*                                      DeadInventoryBoxTemplate;                                 // 0x02C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                DropID;                                                   // 0x02C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x02CC(0x0004) MISSED OFFSET
	struct FName                                       WrapperBoxName;                                           // 0x02D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class APlayerTombBox*                              DeadTombBox;                                              // 0x02D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDebug;                                                   // 0x02E0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x02E1(0x0003) MISSED OFFSET
	int                                                DebugLevel;                                               // 0x02E4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DebugInterval;                                            // 0x02E8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x02EC(0x0004) MISSED OFFSET
	struct FString                                     BehaviorServiceDebugInfo;                                 // 0x02F0(0x0010) (BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData10[0x50];                                      // 0x0300(0x0050) MISSED OFFSET
	class ASTExtraVehicleBase*                         OwnerVehicle;                                             // 0x0350(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCacheMeshOnHit : 1;                                      // 0x0358(0x0001)
	unsigned char                                      UnknownData11[0x27];                                      // 0x0359(0x0027) MISSED OFFSET
...
{
public:
	class UCurveFloat*                                 AimDurationCurve;                                         // 0x0380(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   AimDurationDeviation;                                     // 0x0388(0x0008) (Edit, IsPlainOldData)
	float                                              ShootTurretCD;                                            // 0x0390(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BulletExplosionRange;                                     // 0x0394(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AimingLockRange;                                          // 0x0398(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AimingLockRangeWhenFiring;                                // 0x039C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   TurretAimRange;                                           // 0x03A0(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      bPredictEnemyMove : 1;                                    // 0x03A8(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03A9(0x0003) MISSED OFFSET
	struct FVector2D                                   TurretShootRange;                                         // 0x03AC(0x0008) (Edit, IsPlainOldData)
	unsigned char                                      bAimingConstantLerp : 1;                                  // 0x03B4(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03B5(0x0003) MISSED OFFSET
	float                                              TurretAimingInterpConstantSpeed;                          // 0x03B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TurretAimingInterpSpeed;                                  // 0x03BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SimTurretAimingInterpConstantSpeed;                       // 0x03C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TurretAimingErrorTolerance;                               // 0x03C4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAlsoCheckArcLength : 1;                                  // 0x03C8(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x3];                                       // 0x03C9(0x0003) MISSED OFFSET
	float                                              ShootTargetLocationOffset;                                // 0x03CC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bTraceBlockShootTargetLocation : 1;                       // 0x03D0(0x0001) (Edit)
	unsigned char                                      UnknownData03[0x3];                                       // 0x03D1(0x0003) MISSED OFFSET
	int                                                MaxTraceBlockTryTimes;                                    // 0x03D4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bResetTurretAfterDestroy : 1;                             // 0x03D8(0x0001) (Edit)
	unsigned char                                      bFailedAimingWhenTurretCollided : 1;                      // 0x03D8(0x0001) (Edit)
	unsigned char                                      UnknownData04[0x7];                                       // 0x03D9(0x0007) MISSED OFFSET
	TMap<float, float>                                 BaseHitRate;                                              // 0x03E0(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              ShootMGCD;                                                // 0x0430(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ShootMGDuration;                                          // 0x0434(0x0008) (Edit, IsPlainOldData)
	float                                              ShootMGInterval;                                          // 0x043C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ShootUpDownRange;                                         // 0x0440(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootLeftRightRange;                                      // 0x0448(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootLeftRightRangeDistance;                              // 0x0450(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootTargetSpeedRange;                                    // 0x0458(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootTargetDistanceRangeDueToSpeed;                       // 0x0460(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   MGShootRange;                                             // 0x0468(0x0008) (Edit, IsPlainOldData)
	unsigned char                                      bShouldMissOnPurpose : 1;                                 // 0x0470(0x0001)
	unsigned char                                      bCacheUsingMG : 1;                                        // 0x0470(0x0001)
	unsigned char                                      bCacheUsingTurret : 1;                                    // 0x0470(0x0001)
...
public:
	...
	struct FDiffAIStateInfoBaseMod                     CacheDiffAIStateInfoBaseMod;                              // 0x1068(0x03E0)
	bool                                               IsTouchedPlayer;                                          // 0x1448(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x1449(0x0003) MISSED OFFSET
	uint32_t                                           FrameNo;                                                  // 0x144C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x1450(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                SkipFrameConfig;                                          // 0x1458(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SkipFrameConfigSecond;                                    // 0x145C(0x0004) (ZeroConstructor, IsPlainOldData)
	class AController*                                 OwnerController;                                          // 0x1460(0x0008) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x1468(0x0008) (ZeroConstructor, IsPlainOldData)
	class UAIActingComponent*                          AIActingComp;                                             // 0x1470(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class APawn*                                       MyOwnerPawn;                                              // 0x1478(0x0008) (ZeroConstructor, IsPlainOldData)
	class ABattleRoyaleGameModeBase*                   MyGameMode;                                               // 0x1480(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x48];                                      // 0x1488(0x0048) MISSED OFFSET
	TArray<struct FDamageSource>                       DamageSourcesInfoNew;                                     // 0x14D0(0x0010) (ZeroConstructor)
	TMap<int, class APickUpWrapperActor*>              CacheAINearbyItem;                                        // 0x14E0(0x0050) (ZeroConstructor)
	TArray<class ASTExtraBaseCharacter*>               CacheNearbyEnemies;                                       // 0x1530(0x0010) (ZeroConstructor)
	struct FCacheNearbyItemState                       CacheNearbyItemState;                                     // 0x1540(0x0020)
	class UMLAIControllerComponent*                    MyMLAIControllerComp;                                     // 0x1560(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	uint32_t                                           CacheModeMapId;                                           // 0x1568(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x156C(0x000C) MISSED OFFSET
	class UMLAISubSystem*                              MLAISubSystem;                                            // 0x1578(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMLAIUtilsBase*                              MLAIUtils;                                                // 0x1580(0x0008) (ZeroConstructor, IsPlainOldData)
	class UAIStateInfoDataAsset*                       AIStateInfoDataAsset;                                     // 0x1588(0x0008) (ZeroConstructor, IsPlainOldData)
	class AAIWorldVolume*                              AIWorldVolume;                                            // 0x1590(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x10];                                      // 0x1598(0x0010) MISSED OFFSET
...
// 0x08E0 (0x1E88 - 0x15A8)
class UAIStateInfoComponentBRBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoBRBase                          CacheAIStateInfoBRBase;                                   // 0x15A8(0x0208)
	struct FAIStateInfoBRBase                          LastAIStateInfoBRBase;                                    // 0x17B0(0x0208)
	struct FDiffAIStateInfoBRBaseGeneral               CacheDiffAIStateInfoBRBaseGeneral;                        // 0x19B8(0x0298)
	struct FDiffAIStateInfoBRBase                      CacheDiffAIStateInfoBRBase;                               // 0x1C50(0x0218)
	unsigned char                                      UnknownData00[0x8];                                       // 0x1E68(0x0008) MISSED OFFSET
	class UMLAIUtilsBRBase*                            MLAIUtilsBR;                                              // 0x1E70(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x1E78(0x0010) MISSED OFFSET
...
// 0x0220 (0x17C8 - 0x15A8)
class UAIStateInfoComponentMPBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoMPBase                          CacheAIStateInfoMPBase;                                   // 0x15A8(0x00B0)
	struct FAIStateInfoMPBase                          LastAIStateInfoMPBase;                                    // 0x1658(0x00B0)
	struct FDiffAIStateInfoMPBaseGeneral               CacheDiffAIStateInfoMPBaseGeneral;                        // 0x1708(0x00C0)
...
// 0x00F0 (0x18B8 - 0x17C8)
class UAIStateInfoComponentTeamDeath : public UAIStateInfoComponentMPBase
{
public:
	struct FAIStateInfoTeamDeath                       CacheAIStateInfoTeamDeath;                                // 0x17C8(0x0050)
	struct FAIStateInfoTeamDeath                       LastAIStateInfoTeamDeath;                                 // 0x1818(0x0050)
	struct FDiffAIStateInfoTeamDeathGeneral            CacheDiffAIStateInfoTeamDeathGeneral;                     // 0x1868(0x0050)
...
public:
	...
	struct FDiffAllPlayerBaseInfo                      CacheAllPlayersInfoCSS;                                   // 0x0260(0x0438)
	struct FGlobalGameBaseState                        CacheGlobalGameState;                                     // 0x0698(0x0088)
	struct FGlobalGameBaseState                        LastGlobalGameState;                                      // 0x0720(0x0088)
	struct FDiffGlobalGameBaseState                    DiffGlobalGameState;                                      // 0x07A8(0x0078)
	struct FDiffGlobalGameBaseStateGeneral             DiffGlobalGameStateGeneral;                               // 0x0820(0x00B0)
	TMap<uint32_t, uint32_t>                           DiffStateInfoKeyMap;                                      // 0x08D0(0x0050) (ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData01[0x1B0];                                     // 0x0138(0x01B0) MISSED OFFSET
	TMap<uint32_t, bool>                               AlreadySendDeadStateMap;                                  // 0x02E8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0338(0x0008) MISSED OFFSET
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x0340(0x0030)
	float                                              AirAttackTotalTime;                                       // 0x0370(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0374(0x0004) MISSED OFFSET
	class UAirAttackComponent*                         AirAttackComp;                                            // 0x0378(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FGlobalGameStateBRBase                      GlobalGameState;                                          // 0x0380(0x0170)
	struct FGlobalGameStateBRBase                      LastGlobalGameState;                                      // 0x04F0(0x0170)
	class UMLAIUtilsBase*                              MLAIUtils;                                                // 0x0660(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x70];                                      // 0x0668(0x0070) MISSED OFFSET
	TMap<uint32_t, int>                                CachePlayerRevivalTypes;                                  // 0x06D8(0x0050) (ZeroConstructor)
	class UMLAIStateInfoManager*                       MLAIStateInfoManager;                                     // 0x0728(0x0008) (ZeroConstructor, IsPlainOldData)
	TMap<uint32_t, struct FString>                     VoiceRoomInfoMap;                                         // 0x0730(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FString>                     VoiceServerURLMap;                                        // 0x0780(0x0050) (ZeroConstructor)
	int                                                AirDropTag;                                               // 0x07D0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x07D4(0x0004) MISSED OFFSET
	float                                              ProduceSoundInterval;                                     // 0x07D8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nCanJumpToSky;                                            // 0x07DC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x50];                                      // 0x07E0(0x0050) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.TeammateMLAITeamIDSet
	TArray<uint32_t>                                   SilentMLAIList;                                           // 0x0830(0x0010) (ZeroConstructor)
	bool                                               WhitelistPlayerStatesSwitch;                              // 0x0840(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x7];                                       // 0x0841(0x0007) MISSED OFFSET
	TArray<uint32_t>                                   PlayerWhitelist;                                          // 0x0848(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x8];                                       // 0x0858(0x0008) MISSED OFFSET
	TMap<class AActor*, class ASpecialZoneActor*>      CacheSpecialZoneParents;                                  // 0x0860(0x0050) (ZeroConstructor)
	TArray<class ASpecialZoneActor*>                   CacheDynamicSpecialZone;                                  // 0x08B0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x18];                                      // 0x08C0(0x0018) MISSED OFFSET
	class ABattleRoyaleGameMode*                       CurGameMode;                                              // 0x08D8(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class ASTExtraVehicleBase*                         ControlledVehicle;                                        // 0x0838(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FAIVehicleStateData                         AIVehicleStateData;                                       // 0x0840(0x0080)
	class UAIBehaviorAdapter_VehicleBase*              AIBehaviorAdapter;                                        // 0x08C0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
