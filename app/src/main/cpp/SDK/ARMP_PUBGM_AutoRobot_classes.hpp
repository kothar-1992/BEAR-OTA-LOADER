...
{
public:
	class UClass*                                      EquipedWeaponClass;                                       // 0x1090(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      CharacterClass;                                           // 0x1098(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
