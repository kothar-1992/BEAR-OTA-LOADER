...
public:
	...
	unsigned char                                      bIsMLAI : 1;                                              // 0x04D0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x04D1(0x0003) MISSED OFFSET
	int                                                AILevel;                                                  // 0x04D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                SpawnerCampID;                                            // 0x04D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ESTSpawnerVolume                                   VolumeType;                                               // 0x04DC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x04DD(0x0003) MISSED OFFSET
	float                                              SphereRadius;                                             // 0x04E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     BoxHalfExtent;                                            // 0x04E4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	...
	unsigned char                                      UnknownData06[0x10];                                      // 0x0580(0x0010) MISSED OFFSET
	int                                                WaitSpawn;                                                // 0x0590(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bPlayerEnterRegion : 1;                                   // 0x0594(0x0001)
	unsigned char                                      UnknownData07[0xB];                                       // 0x0595(0x000B) MISSED OFFSET
